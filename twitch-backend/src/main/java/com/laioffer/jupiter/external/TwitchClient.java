...
public class TwitchClient {
    private static final String TOKEN = "Bearer 0vydfji7xbuslrika1x2rbqmxfy8cv";
    private static final String CLIENT_ID = "n6hn2s3jscbddl9yz8la9n9le3zsnc";
    ...
    // Send HTTP request to Twitch Backend based on the given URL, and returns the
    // body of the HTTP response returned from Twitch backend.
    private String searchTwitch(String url) throws TwitchException {
        ...
        try {
            // Define the HTTP request, TOKEN and CLIENT_ID are used for user authentication
            // on Twitch backend
    ...
    // Integrate search() and getGameList() together, returns the dedicated game
    // based on the game name.
    ...
    // Similar to getGameList, convert the json data returned from Twitch to a list
    // of Item objects.
